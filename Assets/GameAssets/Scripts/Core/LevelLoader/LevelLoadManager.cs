...
public class LevelLoadManager : MonoBehaviour
{
    ...
    public void Construct(IGameStateService gameStateService,PlayerController playerController,LevelProgressService levelProgressService)
    {
    ...
    public void LoadLevel()
    {
        ...
        LevelData levelData = chapterData.Chapters[_levelProgressService.CurrentLevel.CurrentChapterIndex].Levels[_levelProgressService.CurrentLevel.CurrentLevelIndex];
