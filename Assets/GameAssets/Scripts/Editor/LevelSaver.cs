...
public static class LevelSaver
{
    ...
    {
        string basePath = "Assets/Resources/ChapterData/Chapters";
    ...
    {
        string chapterDataPath = "Assets/Resources/ChapterData/ChaptersData.asset";
        ...
        if (chapterData == null)
        {
            ...
            if (!Directory.Exists("Assets/Resources/ChapterData"))
                Directory.CreateDirectory("Assets/Resources/ChapterData");
...
//Add Level
    ...
    public static bool ChapterIndexControl(string chapterName)
    {
        const int maxLevelCount = 12;

        string chapterDataPath =
            "Assets/Resources/ChapterData/ChaptersData.asset";

        ChapterData chapterData =
            AssetDatabase.LoadAssetAtPath<ChapterData>(chapterDataPath);
        ...
        Chapter targetChapter =
            chapterData.Chapters.Find(c => c.ChapterName == chapterName);

        if (targetChapter == null)
            return false;

        return targetChapter.Levels.Count < maxLevelCount;
    }
}