...
public class LevelEditor : EditorWindow
{
    ...
    private void ChapterCounter()
    {
        ...
        if (showLevelInfo)
        {
            ...
            string chaptersPath = "Assets/Resources/ChapterData/Chapters";
    ...
    private void Save()
    {
        ...
        if (GUILayout.Button("💾 Save Changes", GUILayout.Height(40)) && !isEditingLoadedLevel)
        {
            ...
            if(!LevelSaver.ChapterIndexControl(chapterName))
            {
                Debug.LogWarning($"Chapter {chapterName} already has 12 levels.");
                return;
            }
